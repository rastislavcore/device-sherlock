...
function isLinux(a: string): boolean {
  return /Linux/.test(a)
}
...
// Main function to generate device information
function getDevice(headers: any = {}, userAgent: string = typeof navigator !== 'undefined' ? navigator.userAgent : ''): Device {
  let mobile = false
  ...
  if (!userAgent) {
    return { userAgent: null, isUnknown: true } as Device;
  }
